...
const SocialItem = ({ url, label, children }) => {
    return (
        <li className="items-center block">
            <a className="inline-flex items-center font-semibold text-gray-700 dark:text-white hover:text-green-500" href={url} target="_blank" rel="noopener noreferrer">
                {children} {label}
            </a>
        </li>
    )
    ...
    return (
        <ul className="">
            <SocialItem url={context.twitter} label="/pixelagil">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"  className="w-8 mr-2 text-gray-700 dark:text-gray-300" fill="currentColor">
            ...
            <SocialItem url={context.github} label="/alexsegen">
                <svg  xmlns="http://www.w3.org/2000/svg" fill="current" viewBox="0 0 24 24" className="w-8 mr-2 text-gray-700 dark:text-gray-300" fill="currentColor">
                    <path fill="none" d="M0 0h24v24H0z"/>
