        ...
        <div className={`flex items-center justify-center min-h-screen bg-black`}>
            ...
            <div className="container mx-auto">
                ...
                <div className="p-10 text-center">
                    <h2 className="mb-10 text-5xl font-bold text-white">Popular Frameworks</h2>
                ...
                <div className="grid max-w-4xl grid-cols-12 gap-6 mx-auto">
                ...
                <div className="max-w-3xl p-10 mx-auto mt-16 text-center border-2 border-gray-800 border-dashed rounded">
