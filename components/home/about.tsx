    ...
    <div className="container mx-auto">
      <div className="p-10 text-center">
        ...
        <p className="mb-4 text-gray-400">
          I have huge experience working with{' '}
          <strong className="font-semibold text-white">Angular, React, VueJS and NodeJS</strong>. And I love taking
          care of <strong className="font-semibold text-white">UI / UX design</strong> , look and feel, user
      ...
      <div className="max-w-3xl p-4 mx-auto mt-16 text-center md:p-8">
        <div className="p-8 border-2 border-gray-800 border-dashed rounded">
          ...
          <p className="mb-4 text-gray-400">These are some frameworks / libs I like to keep studying everyday.</p>
