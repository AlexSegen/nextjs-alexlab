        ...
        <Layout wided={true}>
            <div className="relative p-5 overflow-hidden text-center bg-white dark:bg-black">
                <div className="relative z-10">
                    <h1 className="text-4xl font-bold text-gray-700 dark:text-white">Professional Career</h1>
                    <div className="flex items-center justify-center p-4 text-sm">
                        <Link href="/">
                            <a className="font-semibold text-gray-600 dark:text-gray-400 hover:text-gray-300">Home</a>
                        </Link>
                        <span className="mx-2 text-gray-500">/</span>
                        <span className="font-semibold text-gray-400 dark:text-gray-500">Career</span>
                    </div>
                </div>
            ...
            <div className="container px-4 py-5 mx-auto text-gray-600 dark:text-gray-400 md:py-20 md:px-10 md:grid ">
                
                <div className="grid-cols-12 mb-10 md:grid">
                    <div className="col-span-3 p-2">
                        <h3 className="mb-2 text-xl font-semibold text-gray-700 dark:text-white md:mb-4 md:text-3xl">Education</h3>
                    ...
                    <div className="col-span-3 p-2">
                        <h3 className="mb-2 text-xl font-semibold text-gray-700 dark:text-white md:mb-4 md:text-3xl">Location</h3>
                        <div className="flex items-center justify-start">
                    ...
                    <div className="col-span-3 p-2">
                        <h3 className="mb-2 text-xl font-semibold text-gray-700 dark:text-white md:mb-4 md:text-3xl">Languages</h3>
                        <div className="flex items-center justify-start">
                    ...
                    <div className="col-span-3 p-2">
                        <h3 className="mb-2 text-xl font-semibold text-gray-700 dark:text-white md:mb-4 md:text-3xl">Contact</h3>
                        <div className="flex items-center justify-start">
                ...
                <div className="p-2 mb-10">
                    <div className="block grid-cols-12 gap-6 md:grid">
                        <div className="col-span-6 py-2">
                            <div className="p-4 border border-gray-300 border-dashed rounded dark:border-gray-700">
                                <h3 className="mb-4 text-xl font-semibold text-gray-700 dark:text-white md:mb-10 md:text-2xl">Hard Skills</h3>
                                <div>
                        ...
                        <div className="col-span-6 py-2">
                            <div className="p-4 border border-gray-300 border-dashed rounded dark:border-gray-700">
                                <h3 className="mb-4 text-xl font-semibold text-gray-700 dark:text-white md:mb-10 md:text-2xl">Soft Skills</h3>
                                <div>
                ...
                <div className="p-2 mb-10">
                    <h3 className="mb-10 text-3xl font-semibold text-gray-700 dark:text-white">Experience</h3>

                    <div className="relative pt-4 pl-10 mb-10 border-l border-gray-600 border-opacity-50 border-dashed">
                ...
                <div className="p-2 mb-10">
                    <div className="block">
                        <div className="py-2">
                            <div className="p-4 border border-gray-300 border-dashed rounded dark:border-gray-700">
                                <h3 className="mb-4 text-xl font-semibold text-gray-700 dark:text-white md:mb-10 md:text-3xl">Tools I use</h3>
                                <div>
                                    <Skill caption="Jira"/>
...
function ExperienceItem({className, period, company, description, rol}){
    ...
    <div className={`p-4 mb-4 ${className} relative`}>
        ...
        <h4 className="mb-2 text-xl font-semibold text-gray-700 dark:text-white">{company}</h4>
        <p className="mb-2 text-base font-semibold tet-gray-500 dark:text-blue-400">{rol}</p>
        <p>{description}</p>
    </div>
    )
}
