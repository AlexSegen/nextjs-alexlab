...
const Portfolio = () => {
    ...
    return ( 
        <Layout wided={true}>
            ...
            <div className="container grid grid-cols-10 py-20 mx-auto text-gray-400">

                <Link href="/portfolio/web">
                    <a  className="flex items-center justify-center w-full min-h-full col-span-5 py-40 mb-6 text-5xl font-bold text-center text-white border-2 border-gray-500 border-dashed border-opacity-20 hover:bg-gray-900">
