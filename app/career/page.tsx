      ...
      <div className="container px-4 py-5 mx-auto text-gray-400 md:py-20 md:px-10 md:grid">
        <div className="grid-cols-12 mb-10 md:grid">
          <div className="col-span-3 p-2">
            ...
            <div className="flex items-center justify-start">
              <div className="mr-4">
                <span className="mr-2 opacity-80">Institute:</span> IUJO
              </div>
              <div>
                <span className="mr-2 opacity-80">Year:</span> 2008
              </div>
            </div>
          </div>
          <div className="col-span-3 p-2">
            ...
            <div className="flex items-center justify-start">
              <div className="mr-4">
                <span className="mr-2 opacity-80">Country:</span> Chile
              </div>
              <div>
                <span className="mr-2 opacity-80">City:</span> Santiago
              </div>
            </div>
          </div>
          <div className="col-span-3 p-2">
            ...
            <div className="flex items-center justify-start">
              <div className="mr-4">
                <span className="mr-2 opacity-80">Spanish:</span> Native
              </div>
              <div>
                <span className="mr-2 opacity-80">English:</span> Professional
              </div>
            </div>
          </div>
          <div className="col-span-3 p-2">
            ...
            <div className="flex items-center justify-start">
              <div className="mr-4">
                <span className="mr-2 opacity-80">Phone:</span>{' '}
                <a className="text-blue-400 underline" href="#contact">
                  Contact me
                </a>
              </div>
              <div>
                <span className="mr-2 opacity-80">Linkedin:</span>{' '}
                <a className="text-blue-400 underline" target="_blank" href={linkedin}>
                  Alejandro Vivas
                </a>
              </div>
            </div>
        ...
        <div className="p-2 mb-10">
          ...
          <div className="relative pt-4 pl-10 mb-10 border-l-2 border-gray-600 border-opacity-50 border-dashed">
            <svg
              className="absolute w-8 h-8 -top-2 -left-4"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
